...
it made creating option 2 much easier. 
...
struct movie *sort(struct movie *arr){
	struct movie *L1 = 0;
	struct movie *L2 = 0;
	struct movie *left = arr;
	struct movie *right = arr;
	struct movie *temp = arr;
